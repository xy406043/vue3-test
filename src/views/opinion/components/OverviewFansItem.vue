<template>
  <a-card style="border-top: 0; border-radius: 0px" :bodyStyle="{ padding: '24px 0px' }">
    ...
    <div style="padding: 0px 24px">
      ...
      <a-radio-group v-model:value="choseNoteType4Table" style="margin-bottom: 20px">
...
export default defineComponent({
  ...
  setup(props) {
    ...
    watch(
      choseNoteType4Table,
      () => {
        tableData.value = sourceData.value[category.value].notes[choseNoteType4Table.value];
      },
      {
        immediate: true,
      },
